<x-admin-layout>
    <x-slot name="header">Edit Certificate Record</x-slot>

    <div class="max-w-4xl mx-auto">
        <form method="POST" action="{{ route('admin.certificates.update', $certificate) }}" enctype="multipart/form-data" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white shadow rounded-lg p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="full_name" value="{{ old('full_name', $certificate->full_name) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
                        @error('full_name') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>
                    <div class="space-y-2">
                        <label class="block text-sm font-medium text-gray-700">Birth Name</label>
                        <input type="text" name="birth_name" value="{{ old('birth_name', $certificate->birth_name) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        @if($certificate->passport_photo)
                            <div class="mt-2">
                                <img src="{{ Storage::url($certificate->passport_photo) }}" class="h-20 w-20 rounded-full object-cover border" alt="Current Passport">
                            </div>
                        @endif
                        <p class="text-xs text-gray-500 mt-1">JPG, JPEG, or PNG. Max 2MB. Leave blank to keep current photo.</p>
            ...
            <div class="bg-white shadow rounded-lg p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="school" value="{{ old('school', $certificate->school) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="faculty" value="{{ old('faculty', $certificate->faculty) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        @error('faculty') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>
                    <div class="space-y-2">
                        <label class="block text-sm font-medium text-gray-700">Department</label>
                        <input type="text" name="department" value="{{ old('department', $certificate->department) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        @error('department') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>
                    <div class="space-y-2">
                        <label class="block text-sm font-medium text-gray-700">Programme</label>
                        <input type="text" name="programme" value="{{ old('programme', $certificate->programme) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="qualification" value="{{ old('qualification', $certificate->qualification) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="award" value="{{ old('award', $certificate->award) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="class_of_award" value="{{ old('class_of_award', $certificate->class_of_award) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="date" name="graduation_date" value="{{ old('graduation_date', $certificate->graduation_date?->format('Y-m-d')) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" name="graduation_year" value="{{ old('graduation_year', $certificate->graduation_year) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="academic_session" value="{{ old('academic_session', $certificate->academic_session) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="bg-white shadow rounded-lg p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="matric_number" value="{{ old('matric_number', $certificate->matric_number) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="certificate_number" value="{{ old('certificate_number', $certificate->certificate_number) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="remarks" value="{{ old('remarks', $certificate->remarks) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">
